...
import img from '../../assets/images/jss.png'
...
const Skills = () => {
    return (
        <div>
            ...
            {/* Main Header */}
            <div className="transparent grid lg:grid-cols-2 mx-10 lg:-mt-20 -mt-8 rounded-lg">
                <div className="lg:flex">
                    <div className="w-3/12 lg:-mt-16 lg:ml-16 sm:mx-auto">
                        <img className="rounded-lg lg:border-8 sm:border-4 border-slate-800" src={shathi} alt="" />
                    </div>
                    {/* Name, Title, Icon */}
                    <div className="w-o mx-auto my-auto lg:p-10 sm:p-4 md:p-6 sm:text-center md:text-center">
                        <h1 className="text-5xl font-bold mb-3">Shathi Paul</h1>
                        <h2 className="text-2xl font-semibold">Front-end Developer</h2>
                        <div className="flex my-5 md:justify-center sm:justify-center gap-3">
                ...
                {/* Contact */}
                <div className="grid lg:grid-cols-3 sm:text-center md:text-center items-center">
                    <div>
